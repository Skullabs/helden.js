window.helden=function(){function m(a){return"function"==typeof a}function v(a){return void 0!=a&&null!=a}function q(a,e,d,c){d=d||a;for(var g in a){var f=a[g],b=d[g],b=b==f?null:b;if(f&&m(f.configure)){var h=f.selector?e.find(f.selector):e,b=f.configure(h,d,b,c);b.$=h;var h=d,f=g,r=b.bind(d);r.is_wrapped=!0;r.is_dom_event=b.is_dom_event;h[f]=r}else m(f)&&(d[g]=f.bind(d))}return d}function A(a){function e(){}function d(f){arguments.length&&a.setter.apply(this,arguments);return a.getter.apply(this)}
function c(a){m(this.param)&&(a=this.param.apply(this.model));return d.call(this,a)}function g(){return a.notifiable?c.bind(this):d.bind(this)}a.init=a.init||n;a.getter=a.getter||n;a.setter=a.setter||n;e.prototype=a;return function(f){this.configure=function(b,h,d,c){var l=new e;l.param=f;a.optimize||(l.view=b);l.model=h;l.parentModel=c;l.init.call(this);b=g.call(l);b.call(l,d||f);return b}}}function p(a){function e(a){for(var f=[],b=0;b<a.length;b++)var h=p(a[b]);void 0!=h&&""!==h&&f.push(h);return f}
function d(a){for(var f=[],b=0;b<a.length;b++){var h=p(a.get(b));void 0!=h&&""!==h&&f.push(h)}return f}function c(a){var f={},b;for(b in a)if(!H.unserializableAttributes[b]){var h=p(a[b]);void 0!=h&&""!==h&&(f[b]=h)}return f}return a instanceof s.ObservableArray?d(a):a instanceof Array?e(a):"function"==typeof a?(a=a.is_wrapped&&!a.is_dom_event?a():void 0,a):"object"==typeof a?c(a):a}function w(a,e){function d(){a.apply(this,e)}d.prototype=a.prototype;return new d}function x(a,e,d){this.onAdd=a;this.onRemove=
