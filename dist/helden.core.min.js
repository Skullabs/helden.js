window.helden=function(){function k(a){return"function"==typeof a}function q(a,d,b,g){b=b||a;for(var f in a){var e=a[f],c=b[f],c=c==e?null:c;if(e&&k(e.configure)){var p=e.selector?d.find(e.selector):d,e=e.configure(p,b,c,g);e.$=p;p=b;c=f;e=e.bind(b);e.is_wrapped=!0;p[c]=e}else k(e)&&(b[f]=e.bind(b))}return b}function x(a){function d(f){arguments.length&&a.setter.apply(this,arguments);return a.getter.apply(this)}function b(f){k(this.param)&&(f=this.param.apply(this.model));return d.call(this,f)}function g(){return a.notifiable?
