window.helden=function(){function l(a){return"function"==typeof a}function w(a){return void 0!=a&&null!=a}function r(a,c,d,h){d=d||a;for(var g in a){var f=a[g],b=d[g],b=b==f?null:b;if(f&&l(f.configure)){var e=f.selector?c.find(f.selector):c,f=f.configure(e,d,b,h);d[g]=x(f,d)}else l(f)&&(d[g]=f.bind(d))}return d}function C(a){function c(){}function d(f){arguments.length&&a.setter.apply(this,arguments);return a.getter.apply(this)}function h(a){l(this.param)&&(a=this.param.apply(this.model));return d.call(this,
...
return e};n.onRemove=function(a,e){a=e.ID_ForEachBinder;q.find("#"+a).remove()};n.onSort=function(){for(var a=null,e=null,b=0;b<this.length;b++)a=q.find("#"+this[b].ID_ForEachBinder),null==e?q.prepend(a):e.after(a),e=a};b&&!l(b)&&n.reset(b);return function(a){a&&n.reset(a);return n}}}function v(a,c){function d(){if(!c)return arguments;var a=c.apply(this,arguments);a instanceof Array||(a=[a]);return a}function h(a){return function(){var b=d.apply(this,arguments);return a.val.apply(a,b)}}function g(a){return function(b){arguments.length&&
(b=d(b),a.prop("checked",b[0]));return a.prop("checked")}}function f(a){return function(b){arguments.length&&(b=d(b),a.filter("[value\x3d'"+b[0]+"']").prop("checked",!0));return a.filter(":checked").val()}}function b(a){return function(){var b=d.apply(this,arguments);return a.text.apply(a,b)}}this.selector=a;this.configure=function(a,d,c){var k=a.prop("nodeName");k&&0<=E.indexOf(k.toUpperCase())?(k=a.attr("type"),a="checkbox"==k?g(a):"radio"==k?f(a):h(a)):a=b(a);d=x(a,d);l(c)||d(c);return d}}function B(a,
c,d){this.selector=a;this.configure=function(a,g,f,b){function e(){for(var c=[a,b],e=0;e<arguments.length;e++)c.push(arguments[e]);return d.apply(g,c)}e.is_dom_event=!0;a.on(c,e);return e}}function m(a){this.selector=a;for(var c in m.extensions)this[c]=function(d){return function(){var c=C(m.extensions[d]),c=y(c,arguments);c.selector=a;return c}}(c)}var s=function(){},E=["BUTTON","INPUT","TEXTAREA","SELECT"];m.prototype={bind:function(a){return new v(this.selector,a)},bindIds:function(){return new u(this.selector)},
bindNames:function(){return new u(this.selector,"name")},on:function(){if(2==arguments.length)return new B(this.selector,arguments[0],arguments[1]);throw"Invalid arguments for event binding('on' method): "+arguments;},forEach:function(a){return new A(this.selector,a)}};m.extensions={accessor:{getter:function(){return this.value},setter:function(a){this.value=a}},bindAttr:{getter:function(){return this.view.attr(this.param)},setter:function(a){this.view.attr(this.param,a)}},bindProp:{getter:function(){return this.view.prop(this.param)},
setter:function(a){this.view.prop(this.param,a)}},bindCss:{getter:function(){return this.view.css(this.param)},setter:function(a){this.view.css(this.param,a)}}};var t={Selector:m,DomBinder:v,DomEventBinder:B,ForEachBinder:A,FormBinder:u,ObservableArray:z,dsl:{unserializableAttributes:{toJS:!0,ID_ForEachBinder:!0},observable:function(a,c){var d=c?$(c):$("body");return r(a,d)},observeAView:r,on:m.prototype.on,bind:m.prototype.bind,wasDefined:w,isFunction:l,toJS:p,extension:function(a){return l(a)?function(){var c=
y(a,arguments);c.selector=this.selector;return c}:function(){a.selector=this.selector;return a}},select:function(){if(1==arguments.length&&"string"==typeof arguments[0])return new m(arguments[0]);throw"Invalid syntax";}}};m.apply(t.dsl);return t}();window.H=helden.dsl;if("undefined"!=typeof useGlobals)for(var attr in H)window[attr]||(window[attr]=H[attr]);
